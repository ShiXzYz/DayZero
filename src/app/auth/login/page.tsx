      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-900/30 via-slate-900 to-slate-950 p-12 flex-col justify-between border-r border-slate-800">
        ...
        <div>
          ...
          <p className="text-lg text-slate-400">
            Sign in to monitor your threats, manage alerts, and stay ahead of cybersecurity incidents.
          </p>
        </div>

        <p className="text-sm text-slate-500">
          Security monitoring for modern teams
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 rounded-lg bg-slate-900 border border-slate-700 hover:bg-slate-800 text-white font-medium py-2.5 px-4 transition-colors">
